package configure.test.configurebuilds.utils;
...
public class RecyclerViewFastScroller extends LinearLayout {
    ...
    private void setRecyclerViewPosition(float y) {
        if (recyclerView != null) {
            ...
            final String bubbleText = ((Test101VerticalScrollbarActivity.TestItemAdapter) recyclerView.getAdapter()).getTextToShowInBubble(targetPos);
